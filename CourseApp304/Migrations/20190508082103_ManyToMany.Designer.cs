...
namespace CourseApp304.Migrations
{
    ...
    [Migration("20190508082103_ManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp304.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CourseApp304.Models.StudentAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CourseApp304.Models.StudentCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CourseApp304.Models.StudentAddress", b =>
                {
                    b.HasOne("CourseApp304.Models.Student", "Student")
                        .WithOne("Address")
                        .HasForeignKey("CourseApp304.Models.StudentAddress", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("CourseApp304.Models.StudentCourse", b =>
                {
                    b.HasOne("CourseApp304.Models.Course", "Course")
